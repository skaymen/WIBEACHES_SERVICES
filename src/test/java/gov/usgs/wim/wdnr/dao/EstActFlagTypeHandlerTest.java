...
public class EstActFlagTypeHandlerTest {

    private EstActFlagTypeHandler handler;
    ...
    @Before
    public void setup() {
        handler = new EstActFlagTypeHandler();
    ...
    public void getResultStrTrueTest() throws SQLException {
        given(rs.getString(anyString())).willReturn("E");
    ...
    public void getResultIntTrueTest() throws SQLException {
        given(rs.getString(anyInt())).willReturn("E");
    ...
    public void getResultCallableTrueTest() throws SQLException {
        given(cs.getString(anyInt())).willReturn("E");
