...
public class WeatherDescTypeHandlerTest {

    private WeatherDescTypeHandler handler;
    ...
    @Before
    public void setup() {
        handler = new WeatherDescTypeHandler();
        MockitoAnnotations.initMocks(this);
    }

    @Test
    public void setParameterTest() throws SQLException {
        handler.setParameter(ps, 0, "Mostly sunny", JdbcType.CHAR);
        verify(ps).setString(0, "Mostly Sunny");
