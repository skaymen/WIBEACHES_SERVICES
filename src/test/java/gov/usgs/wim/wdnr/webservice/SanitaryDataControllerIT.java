...
public class SanitaryDataControllerIT {
    ...
    @Test
    @DatabaseSetup("classpath:/testData/lastUpdate/prePost/")
    public void postSanitaryDataValidationErrors() throws Exception {
        String x = "[{\n" +
                "\"user_name\": \"Hilbilly Hank\",\n" +
                "\"user_id\": \"HbH316\",\n" +
                "\"__favorites\": \"\",\n" +
        ...
        System.out.println(rtnAsJSONArray);

        assertEquals(1, rtnAsJSONArray.length());

        assertThat(rtnAsJSONArray,
                sameJSONArrayAs(new JSONArray("[{\"validationErrors\":{\"validationErrors\":[{\"field\":\"numDeadFish\",\"message\":\"numeric value out of bounds (<8 digits>.<0 digits> expected)\"}]},\"idNo\":\"811960c6-e107-ebb3-0a99-0fc60f857f72\"}]\n"))
                        .allowingAnyArrayOrdering());
